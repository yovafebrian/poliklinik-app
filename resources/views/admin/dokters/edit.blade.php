                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.dokters.update', $dokter->id) }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                            ...
                                            required>
                                        @error('nama')resources/views/dokter/create.blade.php resources/views/dokter/edit.blade.php
                            ...
                            <div class="form-group mb-3">
                                ...
                                <a href="{{ route('admin.dokters.index') }}" class="btn btn-secondary">kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
